    ...
    return (
        <div className='flex flex-col items-center justify-center  bg-black text-white  sm:gap-8 gap-4 sm:w-screen w-full h-screen overflow-scroll sm:p-1 p-0.1'>
            <div className='text-center flex flex-col items-center'>
                 ...
                 <img className='sm:h-40 sm:w-40 h-20 w-20 rounded-full border-4 border-purple-800' src="src\assets\images\Gemini_Generated_Image_9804w19804w19804.jpg" alt="developer" />
